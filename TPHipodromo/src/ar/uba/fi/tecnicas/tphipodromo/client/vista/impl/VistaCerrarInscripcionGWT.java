...
public class VistaCerrarInscripcionGWT extends VistaDefaultGWT {
	
	private Listado<CarreraDTO> listado;
	
	private ControladorInscripcion ctrlInscripcion;
	
	public VistaCerrarInscripcionGWT(HasWidgets padre, ControladorInscripcion ctrlInscripcion) {
		super(padre);
