...
public class ApuestaFactory {
	...
	public Apuesta crearApuestaExacta(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException, ParticipantesEnDistintasCarrerasException {
	...
	public Apuesta crearApuestaImperfecta(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException, ParticipantesEnDistintasCarrerasException {
	...
	public Apuesta crearApuestaTrifecta(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException, ParticipantesEnDistintasCarrerasException {
	...
	public Apuesta crearApuestaDoble(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException {
	...
	public Apuesta crearApuestaTriplo(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException {
	...
	public Apuesta crearApuestaCuaterna(List<Participante> participantes, BigDecimal montoApostado) throws CantidadParticipantesInvalidaException {
