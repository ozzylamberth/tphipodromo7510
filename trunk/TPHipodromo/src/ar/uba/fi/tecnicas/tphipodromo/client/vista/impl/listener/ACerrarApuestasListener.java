...
public class ACerrarApuestasListener implements ClickListener {

	private ControladorMenu controlador;
	
	public ACerrarApuestasListener(ControladorMenu controlador) {
		this.controlador = controlador;
	}
	
	public void onClick(Widget sender) {
		controlador.doMostrarCerrarApuestas();
	}
