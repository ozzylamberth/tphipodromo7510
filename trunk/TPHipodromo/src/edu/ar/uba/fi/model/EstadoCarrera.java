...
public enum EstadoCarrera {
	...
	EN_CURSO(new EstadoCarrera[] { A_AUDITAR }),
	CERRADA_A_APUESTAS(new EstadoCarrera[] { EN_CURSO }),
	ABIERTA_A_APUESTAS(new EstadoCarrera[] { CERRADA_A_APUESTAS });
	 ...
	 * @throws TransicionInvalidaEstadoCarreraException Excepcion lanzada si no
	 *  existe un estado hacia el cual hacer la transición.
	 */
	 ...
	 * @throws TransicionInvalidaEstadoCarreraException Excepcion lanzada si no
	 * es posible la transición hacia el estado cancelado.
	 */
	...
	/**
	 * @param nuevoEstado Nuevo estado hacia el que se desea evaluar la posible transición.
	 * @return Devuelve true si la transición es posible, false en caso contrario.
	 */
