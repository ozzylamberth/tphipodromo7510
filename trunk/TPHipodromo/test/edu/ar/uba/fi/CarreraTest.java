...
public class CarreraTest extends TestCase {
	...
	public void testEstadosCarrera() {
		...
		assertEquals(carrera.getEstadoCarrera(), EstadoCarrera.ABIERTA_A_APUESTAS);
		...
		assertEquals(carrera.getEstadoCarrera(), EstadoCarrera.CERRADA_A_APUESTAS);
	...
	public void testResultadosCarreraInvalidos() throws ParticipanteNoCalificadoException {
