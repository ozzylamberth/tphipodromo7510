...
public class VistaLoginGWT extends VistaGWT implements
	...
	public VistaLoginGWT(final ControladorLogin ctrlLogin) {
	    ...
	    Label lblTitulo = new Label(ctes.login());
	    ...
	    Label lblUsuario = new Label(ctes.usuario());
	    
	    Label lblContrasenia = new Label(ctes.contrasenia());
	    ...
	    final Button btnAceptar = new Button(ctes.aceptar());
